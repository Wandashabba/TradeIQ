...
// The a11y guard moved to `a11y_guard.dart` when the operations group needed
// the same law on nine more screens. Re-exported here so this group's tests
// keep reading `territory_harness.dart` alone.
