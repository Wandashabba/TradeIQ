...
void main() {
  ...
  testWidgets(
    'each state paints a genuinely different shape, same colour throughout',
    (tester) async {
  ...
  group('the at-store pulse', () {
    ...
    testWidgets(
      'renders the still glyph, with no pulse widget built, when reduceMotion is on',
      (tester) async {
        ...
        expect(
          ...
          findsNothing,
          reason:
              'reduceMotion must skip the pulse entirely, not just its '
    ...
    testWidgets(
      'shows an expand-and-fade halo mid-flight under normal motion, and settles',
      (tester) async {
        ...
        expect(
          ...
          findsOneWidget,
          reason:
              'under normal motion the halo should be mid-flight at 400ms '
