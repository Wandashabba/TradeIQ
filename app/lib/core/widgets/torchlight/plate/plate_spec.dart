...
class PlateSpec {
  ...
  ///
  /// `min(clamp(0.40 × vh, 200, 320), vh − 440)`. The second term is the one
  ...
  ///
  /// **The proportion moved from 0.44/360 to 0.40/320 on 25 September 2026.**
  ...
  /// reference shows three. 320 is what three rows and the lead card cost,
  /// measured rather than guessed — see `floor_proportion_test.dart`.
  ///
  ...
  static double heightFor(double viewportHeight) {
    final proportional = (viewportHeight * 0.40).clamp(200.0, 320.0);
