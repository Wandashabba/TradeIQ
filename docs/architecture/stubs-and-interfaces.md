...
| Behavioural fraud / ghost-visit detection | ✅ **implemented** in `backend/src/modules/fraud` (real heuristic engine); `fraud.stub.ts` removed | — | — | https://github.com/Wandashabba/TradeIQ/issues/3 |
| Predictive field dispatch | ✅ **implemented** in `backend/src/modules/dispatch` (real nearest-agent); `dispatch.stub.ts` removed | — | — | https://github.com/Wandashabba/TradeIQ/issues/4 |
